...
-- Define os estados, incluindo a tela inicial e telas para cada fractal com suas iterações.
data GameState = StartScreen | SierpinskiScreen Int | KochScreen Int | MandelbrotScreen Int | SierpinskiCarpetScreen Int
